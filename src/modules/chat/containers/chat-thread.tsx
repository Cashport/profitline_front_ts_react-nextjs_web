...
export default function ChatThread({
  ...
  // Race condition with mutate can ocurr with new messages via socket, read IMPORTANT below
  useEffect(() => {
    ...
    subscribeToMessages((msg: IMessageSocket) => {
      ...
      // IMPORTANT: Must copy ALL fields, if new ones are added in the backend
      // Without these fields, messages arrive and could generate errors or strange behaviour
      const newMessage: IMessage = {
        ...
        templateName: msg.templateName ?? undefined, // Added: Required for template rendering
        templateData: msg.templateData ?? undefined, // Added: Required for template rendering
