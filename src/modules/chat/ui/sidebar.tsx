...
import {
  ...
  SheetHeader,
  SheetTitle
} from "@/modules/chat/ui//sheet";
import { Skeleton } from "@/modules/chat/ui//skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
// Corregido con forwardRef y tipos correctos
...
const SidebarGroupLabel = React.forwardRef<HTMLDivElement, SidebarGroupLabelProps>(
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ref={ref as any} // Type assertion necesario por la naturaleza polimórfica
...
// Corregido SidebarMenuSubButton
