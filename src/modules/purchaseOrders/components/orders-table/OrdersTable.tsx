...
const renderInvoices = (invoices: string[] | null) => {
  if (!invoices || invoices.length === 0) return <span className="text-gray-400">–</span>;
  return (
    <span className="text-xs line-clamp-2 break-words" title={invoices.join(", ")}>
      {invoices.join(", ")}
    </span>
  );
};
                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="flex flex-col">
                          <span className="text-cashport-black">
                            {order.orderNumber || "-"}
                          </span>
