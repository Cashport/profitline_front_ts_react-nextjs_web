...
export default function ModalNuevaNegociacion({ onClose, onSubmit }: Props) {
  ...
  return (
    <ModalBase onClose={onClose}>
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-5 border-b border-[#EEEEEE] flex-shrink-0">
          <div className="flex items-center gap-2">
            <ClipboardList size={16} className="text-[#141414]" />
            <h2 className="text-base font-bold text-[#141414]">Nueva negociación</h2>
          </div>
          <button
            onClick={onClose}
          ...
          <div>
            ...
            <div className="border border-[#EEEEEE] rounded-xl overflow-hidden">
              ...
              <div className="flex items-center gap-3 px-4 py-2.5 bg-[#FAFAFA] border-b border-[#EEEEEE]">
                ...
                <span className="text-xs font-bold text-[#141414] w-24 text-right">
                  Descuento %
                </span>
              </div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-between px-6 py-4 border-t border-[#EEEEEE] flex-shrink-0">
