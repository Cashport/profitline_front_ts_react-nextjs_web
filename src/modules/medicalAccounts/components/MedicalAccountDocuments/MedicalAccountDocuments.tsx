...
export const docLabel = (doc: IMedicalAccountDocumentApi): string =>
  doc.service_description ?? doc.invoice_number ?? `Documento ${doc.sequence}`;

export const handleDownloadFile = (url: string | null | undefined) => {
  ...
  return (
    <div className="flex" style={{ minHeight: 520 }}>
      ...
      <div className="flex w-1/2 shrink-0 flex-col" style={{ minHeight: 520 }}>
        {viewingDoc ? (
          <PdfPanel doc={viewingDoc} label={docLabel(viewingDoc)} onDownload={handleDownloadFile} />
        ) : (
